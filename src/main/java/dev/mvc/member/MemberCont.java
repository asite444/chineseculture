...
//http://localhost:9091/member/checkNickname.do?checknickname=삼도수군통제사
 /**
 * 별명 중복 체크, JSON 출력
 * @return
 */
 ...
 @RequestMapping(value="/member/checkNickname.do", method=RequestMethod.GET ,
                        produces = "text/plain;charset=UTF-8" )
 public String checkNickname(String checknickname) {
   int cnt = this.memberProc.checkNickname(checknickname);
   
   System.out.println("별명 확인 요청됨:"+checknickname);
   JSONObject json = new JSONObject();
   json.put("cnt", cnt);
