...
<DIV class='title_line'>
  <A href="../chinesegrp/list.do" class='title_link'>카테고리 그룹</A> > 
...
<DIV class='content_body'>
  <ASIDE class="aside_right">
    <A href="./create.do?cateno=${chVO.chno }">등록</A>
    <span class='menu_divide' >│</span>
    <A href="javascript:location.reload();">새로고침</A>
    <span class='menu_divide' >│</span>
    <A href="./list_by_chno_search_paging.do?cateno=${cheVO.chno }">기본 목록형</A>    
    <span class='menu_divide' >│</span>
    <A href="./list_by_chno_grid_search_paging.do?cateno=${chVO.chno }">갤러리형</A>
    <span class='menu_divide' >│</span>
    <A href="./update_text.do?contentsno=${contentsno }&now_page=${param.now_page }">수정</A>
  </ASIDE> 
  
<DIV style="text-align: right; clear: both;">    
    <form name='frm' id='frm' method='get' action='./list_by_chno_search.do'>
      ...
      <c:if test="${param.word.length() > 0 }">
        <button type='button' 
                     onclick="location.href='./list_by_chno_search.do?chno=${chVO.chno}&now_page=${param.now_page }&word='">검색 취소</button>  
      </c:if>    
    </form>
  </DIV>
