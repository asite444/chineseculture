...
<DIV class='title_line'><A href="../favfieldgrp/list.do" class='title_link'>주제</A> > ${favfieldVO.favtitle } 조회(수정)</DIV>
...
<DIV class='content_body'>
  <DIV id='panel_create' style='padding: 10px 0px 10px 0px; background-color: #F9F9F9; width: 100%; text-align: center;'>
    <FORM name='frm_update' id='frm_update' method='POST' action='./update.do'>
      ...
      <input type='number' name='favgrpno' value='${favfieldVO.favgrpno }'   required="required" style='width: 3%;'
           min='1' max='8'     autofocus="autofocus">
      <label>주제</label>
      <input type='text' name='favtitle' value='${favfieldVO.favtitle }' required="required" style='width: 10%;'
                 >
                 <label>내용</label>
      <input type='text' name='favex' value='${favfieldVO.favex }'   required="required" style='width: 40%;'
                 >
