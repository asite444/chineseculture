...
<DIV class='title_line'><A href="../chinesegrp/list.do" class='title_link'>주제</A> > 등록</DIV>
 ...
 <DIV class='content_body' >
   ...
   <div class="form-group">
       ...
       <div class="col-md-8">
         <input type='text' name='chgrpno' value='' required="required"  placeholder="그룹번호(1~7)"  
    ...
    <div class="form-group">
       ...
       <div class="col-md-8">
         <input type='text' name='chtitle' value='' required="required"  placeholder="제목 이름"  
    ...
    <div class="form-group">
       ...
       <div class="col-md-8">
         <input type='text' name='chex' value='' required="required"  placeholder="설명"  
                     class="form-control" style='width: 50%;'>
       </div>
    </div>
